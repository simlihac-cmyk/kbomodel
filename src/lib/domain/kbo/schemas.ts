...
export const playerSchema = z.object({
  ...
  nameKo: z.string(),
  nameEn: z.string(),
  officialPlayerCode: z.string().nullable().optional().default(null),
  birthDate: z.string().nullable(),
  batsThrows: z.string().nullable(),
  heightWeight: z.string().nullable().optional().default(null),
  careerHistory: z.string().nullable().optional().default(null),
  draftInfo: z.string().nullable().optional().default(null),
  joinInfo: z.string().nullable().optional().default(null),
...
export const playerSeasonStatSchema = z.object({
  ...
  battingAverage: z.number().nullable().optional().default(null),
  atBats: z.number().nullable(),
  runs: z.number().nullable().optional().default(null),
  hits: z.number().nullable(),
  homeRuns: z.number().nullable(),
  rbi: z.number().nullable().optional().default(null),
  stolenBases: z.number().nullable().optional().default(null),
  walks: z.number().nullable().optional().default(null),
  onBasePct: z.number().nullable().optional().default(null),
  sluggingPct: z.number().nullable().optional().default(null),
  ...
  holds: z.number().nullable().optional().default(null),
  whip: z.number().nullable().optional().default(null),
  hitsAllowed: z.number().nullable().optional().default(null),
  homeRunsAllowed: z.number().nullable().optional().default(null),
  runsAllowed: z.number().nullable().optional().default(null),
  earnedRuns: z.number().nullable().optional().default(null),
  opponentAvg: z.number().nullable().optional().default(null),
  war: z.number().nullable(),
});

export const playerCareerStatSchema = z.object({
  playerCareerStatId: z.string(),
  playerId: z.string(),
  year: z.number().int(),
  teamLabel: z.string(),
  statType: z.enum(["hitter", "pitcher"]),
...
export const playerGameStatSchema = z.object({
  ...
  statType: z.enum(["hitter", "pitcher"]),
  battingAverage: z.number().nullable().optional().default(null),
  atBats: z.number().nullable().optional().default(null),
  runs: z.number().nullable().optional().default(null),
  hits: z.number().nullable().optional().default(null),
  homeRuns: z.number().nullable().optional().default(null),
  rbi: z.number().nullable().optional().default(null),
  stolenBases: z.number().nullable().optional().default(null),
  walks: z.number().nullable().optional().default(null),
  era: z.number().nullable().optional().default(null),
  result: z.string().nullable().optional().default(null),
  plateAppearances: z.number().nullable().optional().default(null),
  inningsPitched: z.number().nullable().optional().default(null),
  hitsAllowed: z.number().nullable().optional().default(null),
  homeRunsAllowed: z.number().nullable().optional().default(null),
  runsAllowed: z.number().nullable().optional().default(null),
  earnedRuns: z.number().nullable().optional().default(null),
  opponentAvg: z.number().nullable().optional().default(null),
  strikeouts: z.number().nullable().optional().default(null),
...
export const gameProbabilitySnapshotSchema = z.object({
  ...
  tieProb: z.number(),
  pickFavoriteSide: z.enum(["home", "away"]),
  pickConfidenceScore: z.number(),
  pickConfidenceLevel: z.enum(["pass", "lean", "pick", "strong"]),
...
export const simulationSnapshotSchema = z.object({
  ...
  shortTermRankVolatility: z.array(
    z.object({
      seasonTeamId: z.string(),
      averageRank: z.number(),
      avgAbsMove: z.number(),
      moveProb: z.number(),
      bigMoveProb: z.number(),
      riseProb: z.number(),
      fallProb: z.number(),
    }),
  ).optional(),
